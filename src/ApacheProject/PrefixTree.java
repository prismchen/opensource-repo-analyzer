...
/**
 * Data structure that helps to store Apache Java projects' names in a compressed way (Trie), and 
 * provide method to search for 
 */
public class PrefixTree {
    ...
    /**
    * Trie node that represents a section of valid imports, 
    * e.g. a Node could represent "commons" in "org.apache.commons.configuration.method"
    */
    class Node {
    ...
    */
    ...
    /**
    * Search to find if string[] words could come from an Apache project stored in trie.
    * If found, return the full project name; otherwise return null
    */
